...
def main():
    ...
    # Switched to false for testing, focusing on profiling the code without plotting overhead ###
    ...
    # Save figure (disabled for profiling) ###
...
if __name__ == "__main__":
    ...
    # Running in terminal with (redirecting output to file):

    # kernprof -l -v line_profiling-ns.py > line_profile_ns.txt