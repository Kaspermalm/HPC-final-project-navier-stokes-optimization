...
@profile
def poisson_solve(
    cnp.ndarray[complex128_t, ndim=2] rho_hat,
    cnp.ndarray[float64_t, ndim=2] kSq_inv,
):
...
@profile
def div(
    cnp.ndarray[complex128_t, ndim=2] vx_hat,
    cnp.ndarray[complex128_t, ndim=2] vy_hat,
    cnp.ndarray[complex128_t, ndim=2] ikx,
    cnp.ndarray[complex128_t, ndim=2] iky,
):
...
def curl(
    ...
    cnp.ndarray[complex128_t, ndim=2] ikx,
    cnp.ndarray[complex128_t, ndim=2] iky,
    cnp.ndarray[complex128_t, ndim=2] diff_hat,
    cnp.ndarray[complex128_t, ndim=2] work_hat,
    cnp.ndarray[float64_t, ndim=2] wz,
    object ifft_wz,
):
...
def main(int N=400):
    ...
    cdef cnp.ndarray[float64_t, ndim=2] yy
    cdef cnp.ndarray[float64_t, ndim=2] kx
    cdef cnp.ndarray[float64_t, ndim=2] ky
    cdef cnp.ndarray[float64_t, ndim=2] kSq
    cdef cnp.ndarray[float64_t, ndim=2] kSq_inv
    cdef cnp.ndarray[cnp.npy_bool, ndim=2] mask
    cdef cnp.ndarray[complex128_t, ndim=2] ikx
    cdef cnp.ndarray[complex128_t, ndim=2] iky
    cdef cnp.ndarray[cnp.npy_bool, ndim=2] dealias
    cdef cnp.ndarray[float64_t, ndim=2] diffuse_denom
